...
const LicitacionesList = ({
  ...
  return (
    <div className="licitometro-codex-list licitometro-codex-list--complete codex-ui3-record-ledger space-y-2" ref={listTopRef}>
      ...
      <div className="codex-list-workbench flex gap-4">
        ...
        {/* Contenido principal */}
        <div className="codex-list-main flex-1 min-w-0">
          {/* Toolbar simplificado */}
          <div className="codex-list-toolbar lg:sticky lg:top-14 z-20 bg-[#f8f9fa] pb-2 space-y-1.5">
            <DecisionSummary
            ...
            <div className="flex items-center gap-1.5 sm:gap-2 flex-wrap">
              ...
              <select
                ...
                className="codex-list-mobile-control lg:hidden px-2 py-1.5 bg-gray-100 rounded-lg font-bold text-xs text-gray-600 hover:bg-gray-200 transition-colors flex-shrink-0 border-0 outline-none cursor-pointer"
                title="Agrupar por"
              >
              ...
              <button
                ...
                className="codex-list-mobile-control lg:hidden flex items-center gap-1 px-2 py-1.5 bg-gray-100 rounded-lg font-bold text-xs text-gray-600 hover:bg-gray-200 transition-colors flex-shrink-0"
              >
              ...
              <div className="space-y-3">
                {Object.entries(groupedLicitaciones).map(([groupName, groupItems]) => (
                    <React.Fragment key={groupName}>
                      {prefs.groupBy !== 'none' && (
                        <div className={`codex-list-group-header rounded-lg p-3 flex items-center justify-between ${
