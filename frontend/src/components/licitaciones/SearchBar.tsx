      ...
      <div className="relative" ref={dropdownRef}>
        <div className="relative flex items-center">
          ...
          <input
            ...
            className="w-full pl-9 pr-8 py-2 bg-gray-50 border border-transparent focus:border-blue-500 rounded outline-none text-sm text-gray-700 font-medium"
            value={localSearch}
        ...
        {showRecent && recentSearches.length > 0 && (
          <div className="absolute top-full left-0 right-0 mt-1 bg-white border border-gray-200 rounded z-40 py-1 max-h-64 overflow-y-auto">
