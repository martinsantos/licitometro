      ...
      <div className="relative" ref={dropdownRef}>
        <div className="relative flex items-center">
          ...
          <input
            ...
            className="lic-control-transition w-full pl-9 pr-8 py-2 bg-gray-50 border border-gray-200 focus:border-emerald-500 focus:bg-white rounded-lg outline-none text-sm text-gray-700 font-medium"
            value={localSearch}
        ...
        {showRecent && recentSearches.length > 0 && (
          <div className="lic-popover absolute top-full left-0 right-0 mt-1 z-40 py-1 max-h-64 overflow-y-auto">
