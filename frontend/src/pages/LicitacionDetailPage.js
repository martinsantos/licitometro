...
const LicitacionDetailPage = ({ userRole }) => {
  ...
  const toggleSave = async () => {
    ...
    if (isSaved) {
      ...
      fetch(`${API}/licitaciones/favorites/${id}`, { method: 'DELETE', credentials: 'include' }).catch(() => {});
    } else {
      savedItems.push(id);
      ...
      fetch(`${API}/licitaciones/favorites/${id}`, { method: 'POST', credentials: 'include' }).catch(() => {});
          ...
          <div className="relative bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 p-4 sm:p-6 lg:p-10">
            ...
            <div className="relative flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
              ...
              <div className="flex sm:flex-col gap-3">
                ...
                <a
                  href="/cotizar"
                  className="p-3 rounded-2xl bg-emerald-500 text-white hover:bg-emerald-400 transition-all duration-300 flex items-center justify-center"
