...
const LicitacionTable: React.FC<LicitacionTableProps> = ({
  ...
  return (
    <div className="codex-data-table codex-data-table--complete bg-white rounded border border-gray-100 overflow-hidden">
              ...
              return (
                ...
                >
                  ...
                  <td className="px-3 py-4 text-center whitespace-nowrap">
                    {tableDays !== null ? (
                      <span className={`codex-table-day ${tableUrgency}`}>
                  ...
                  <td className="px-4 py-4 text-right">
                    <div className="flex items-center justify-end gap-1">
                      ...
                      <button
                        ...
                        className="codex-icon-button text-gray-400 hover:text-green-500"
                      >
