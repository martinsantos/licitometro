    ...
    <div className="space-y-2" ref={listTopRef}>
      ...
      <div className="flex gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="lg:sticky lg:top-14 z-20 bg-gray-50 pb-1.5 space-y-1">
            ...
            <div className="flex items-center gap-1.5">
              ...
              {/* Mobile filter button — next to search for quick access */}
              <button
                onClick={() => setMobileFiltersOpen(true)}
                className="lg:hidden flex items-center gap-1 px-2.5 py-2 bg-gray-100 rounded-lg font-bold text-xs text-gray-600 hover:bg-gray-200 transition-colors flex-shrink-0"
              >
            ...
            {/* Action buttons — single scrollable row on mobile, no wrapping */}
