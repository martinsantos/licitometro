...
# Rubro shortcuts → category name (must match exact values in DB)
RUBRO_SHORTCUTS = {
    ...
    "medicamentos": "EQUIPAMIENTO MEDICO, FARMACEUTICO Y DE LABORATORIO",
    "farmacia": "EQUIPAMIENTO MEDICO, FARMACEUTICO Y DE LABORATORIO",
    "construccion": "CONSTRUCCION",
    "construcción": "CONSTRUCCION",
    "obra": "CONSTRUCCION",
    "obras": "CONSTRUCCION",
    "mantenimiento": "MANTENIMIENTO Y REPARACION",
    "reparacion": "MANTENIMIENTO Y REPARACION",
    "seguridad": "SEGURIDAD Y VIGILANCIA",
    "vigilancia": "SEGURIDAD Y VIGILANCIA",
    "textil": "INDUMENTARIA, CONFECCION Y TEXTILES",
    "indumentaria": "INDUMENTARIA, CONFECCION Y TEXTILES",
    "vehiculos": "VEHICULOS, AUTOMOTORES Y REPUESTOS",
    "vehículos": "VEHICULOS, AUTOMOTORES Y REPUESTOS",
    "automotores": "VEHICULOS, AUTOMOTORES Y REPUESTOS",
    "muebles": "EQUIPAMIENTO DE OFICINA Y MUEBLES",
    "mobiliario": "EQUIPAMIENTO DE OFICINA Y MUEBLES",
    "electricidad": "ELECTRICIDAD Y TELEFONIA",
    "electrico": "ELECTRICIDAD Y TELEFONIA",
    "eléctrico": "ELECTRICIDAD Y TELEFONIA",
    ...
    "herramientas": "FERRETERIA Y HERRAMIENTAS",
    "transporte": "SERVICIOS DE TRANSPORTE Y LOGISTICA",
    "logistica": "SERVICIOS DE TRANSPORTE Y LOGISTICA",
    "residuos": "RESIDUOS Y MEDIO AMBIENTE",
    "medio ambiente": "RESIDUOS Y MEDIO AMBIENTE",
}
