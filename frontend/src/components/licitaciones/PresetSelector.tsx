...
const PresetSelector: React.FC<PresetSelectorProps> = ({
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {open && (
        <div className="codex-preset-menu absolute right-0 sm:right-0 top-full mt-1 bg-white border border-gray-200 rounded-xl z-30 w-64 max-w-[calc(100vw-2rem)] py-2">
