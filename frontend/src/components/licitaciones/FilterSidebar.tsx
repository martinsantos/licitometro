...
const FilterSidebar: React.FC<FilterSidebarProps> = ({
  ...
  if (isCollapsed) {
    return (
      <div className="w-12 flex-shrink-0">
        <div className="codex-filter-panel h-[calc(100vh-3.5rem)] bg-white border border-gray-100 rounded flex flex-col items-center py-3 gap-2">
  ...
  return (
    <div className="w-[280px] flex-shrink-0">
      <div className="codex-filter-panel h-[calc(100vh-3.5rem)] overflow-y-auto bg-white border border-gray-100 rounded">
        {/* Header */}
