...
CRON_JOBS = [
    ...
    {
        "id": "alertas_checker",
        "name": "Alertas checker (every 10 min)",
        "trigger": IntervalTrigger(minutes=10),
        "service_module": "services.alertas_checker_service",
        "service_factory": "get_alertas_checker_service",
        "method": "run_check_cycle",
        "max_instances": 1,
    },
    {
        "id": "ai_extraction_v2_mendoza",
        "name": "AI extraction 0.2 Mendoza batch",
        "trigger": CronTrigger(hour=10, minute=45),
        "service_module": "services.ai_extraction_cron_service",
        "service_factory": "get_ai_extraction_cron_service",
        "method": "run_daily_mendoza_batch",
        "max_instances": 1,
    },
    {
        "id": "ai_source_backfill_v2_mendoza",
        "name": "AI extraction 0.2 Mendoza source backfill",
        "trigger": CronTrigger(hour=12, minute=10),
        "service_module": "services.ai_extraction_cron_service",
        "service_factory": "get_ai_extraction_cron_service",
        "method": "run_daily_undercovered_mendoza_backfill",
        "max_instances": 1,
    },
    {
        "id": "readiness_overdue_digest",
        "name": "Readiness overdue action digest",
        "trigger": CronTrigger(hour=8, minute=40),
        "service_module": "services.readiness_action_service",
        "service_factory": "get_readiness_action_service",
        "method": "send_overdue_digest",
        "max_instances": 1,
    },
    {
        "id": "readiness_source_coverage_digest",
        "name": "Readiness source coverage digest",
        "trigger": CronTrigger(hour=11, minute=15),
        "service_module": "services.readiness_action_service",
        "service_factory": "get_readiness_action_service",
        "method": "send_source_coverage_digest",
        "max_instances": 1,
    },
    {
        "id": "ai_backfill_retry_digest",
        "name": "AI backfill retry outcome digest",
        "trigger": CronTrigger(hour=12, minute=40),
        "service_module": "services.readiness_action_service",
        "service_factory": "get_readiness_action_service",
        "method": "send_backfill_retry_digest",
        "max_instances": 1,
    },
    {
        "id": "input_quality_repair_digest",
        "name": "Input-quality repair digest",
        "trigger": CronTrigger(hour=13, minute=10),
        "service_module": "services.readiness_action_service",
        "service_factory": "get_readiness_action_service",
        "method": "send_input_quality_repair_digest",
        "max_instances": 1,
    },
    {
        "id": "readiness_source_coverage_snapshot",
        "name": "Readiness source coverage snapshot",
        "trigger": CronTrigger(hour=23, minute=30),
        "service_module": "services.readiness_action_service",
        "service_factory": "get_readiness_action_service",
        "method": "snapshot_source_coverage",
        "max_instances": 1,
    },
]
